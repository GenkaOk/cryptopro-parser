var cryptoProParser = function (e) {
    var t = {};
    ...
    var r = n(2), a = n(3);
    t.parse = function (e) {
        var t = e.match(/([а-яА-Яa-zA-Z0-9.]+)=(?:("[^"]+?")|(.+?))(?:,|$)/g), n = {};
        if (t) return n = t.map((function (e) {
            var t, n, r, o = e.match(/^([а-яА-Яa-zA-Z0-9.]+)=(.+?),?$/), i = null == o ? void 0 : o[1],
                s = null === (n = null === (t = null == o ? void 0 : o[2]) || void 0 === t ? void 0 : t.replace(/^"(.*)"/, "$1")) || void 0 === n ? void 0 : n.replace(/"{2}/g, '"'),
                l = null == i ? void 0 : i.match(/^OID\.(.*)/), u = null == l ? void 0 : l[1], c = !1;
            if (u) {
                var f = a.OIDS_DICTIONARY[u];
                f && (i = f, c = !0)
            }
            var d = null === (r = a.ISSUER_TAGS_TRANSLATIONS.find((function (e) {
                return e.possibleNames.find((function (e) {
                    return e === i
                }))
            }))) || void 0 === r ? void 0 : r.translation;
            return d && (i = d, c = !0), {description: s, title: i, isTranslated: c}
        })), r.getObject(n)
    }
}, function (e, t, n) {
    t.subjectName = n(0), t.issuerName = n(4)
}, function (e, t) {
    t.getObject = function (e) {
        return {
            data: e, getParsedData: function () {
                return this.data
            }, findByName: function (e) {
                var t;
                return e = e.toLowerCase(), null === (t = this.data.find((function (t) {
                    return t.title.toLowerCase() === e
                }))) || void 0 === t ? void 0 : t.description
            }
        }
    }
}, function (e, t) {
    t.ISSUER_TAGS_TRANSLATIONS = [{
        possibleNames: ["UnstructuredName"],
        translation: "Неструктурированное имя"
    }, {possibleNames: ["CN"], translation: "Владелец"}, {
        possibleNames: ["C"],
        translation: "Страна"
    }, {possibleNames: ["S"], translation: "Регион"}, {
        possibleNames: ["STREET"],
        translation: "Адрес"
    }, {possibleNames: ["O"], translation: "Компания"}, {
        possibleNames: ["OU"],
        translation: "Подразделение"
    }, {possibleNames: ["T"], translation: "Должность"}, {
        possibleNames: ["ОГРН", "OGRN"],
        translation: "ОГРН"
    }, {possibleNames: ["ОГРНИП", "OGRNIP"], translation: "ОГРНИП"}, {
        possibleNames: ["СНИЛС", "SNILS"],
        translation: "СНИЛС"
    }, {possibleNames: ["ИНН", "INN"], translation: "ИНН"}, {
        possibleNames: ["E"],
        translation: "Email"
    }, {possibleNames: ["L"], translation: "Город"}], t.OIDS_DICTIONARY = {
